          ...
          <li key={team.id} className={styles.card}>
            <Link href={`/teams/${team.id}`} className={styles.cardLink}>
              ...
              <div className={styles.cardBadges}>
                ...
                <span className={styles.cardMeta}>{formatMemberCount(team.memberCount)}</span>
              </div>
              <p className={styles.cardVerification} data-verified={team.verified}>
            ...
            <tr key={team.id}>
              ...
              <td>
                <Badge tone={toneForVerified(team.verified)}>
                  {team.verified ? `Verified · ${team.lastActiveYear}` : `Unverified`}
                </Badge>
              </td>
            </tr>
          ))}
